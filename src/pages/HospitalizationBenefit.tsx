...
const HospitalizationBenefit: React.FC = () => {
  const { goToNextStep, benefitType } = useFormContext();
    ...
    return (
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
          ...
          <FormField
            label="IPD Annual Limit"
            fieldName="ipdAnnualLimit"
            placeholder="Enter amount"
          />
          
          <FormField
            label="OPD Annual Limit"
            fieldName="opdAnnualLimit"
            placeholder="Enter amount"
          />
          ...
          <FormField
            label="Emergency International Coverage"
            fieldName="emergencyInternational"
            type="select"
            placeholder="Select your option"
            options={coverageOptions}
    ...
    return (
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
          ...
          <FormField
            label="OPD Clinics Annual Limit"
            fieldName="opdClinicsLimit"
            placeholder="Enter amount"
          />
          
          <FormField
            label="OPD Pharmacy Annual Limit"
            fieldName="opdPharmacyLimit"
            placeholder="Enter amount"
          />
          
          <FormField
            label="OPD Lab Annual Limit"
            fieldName="opdLabLimit"
            placeholder="Enter amount"
          />
